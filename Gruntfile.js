...
//      }
    ...
    replace: {
        cdnify: {
            ...
            replacements: [
                ...
                {from: 'bower_components/cids-node-path-widget/dist/scripts/cids-node-path-widget.js', to: 'bower_components/cids-node-path-widget/dist/scripts/cids-node-path-widget.min.js'},
                {from: 'bower_components/scenario-evolution-widget-angular/dist/scripts/scenario-evolution-widget-angular.js', to: 'bower_components/scenario-evolution-widget-angular/dist/scripts/scenario-evolution-widget-angular.min.js'},
                {from: 'bower_components/scenario-evolution-widget-angular/dist/styles/scenario-evolution-widget-angular.css', to: 'bower_components/scenario-evolution-widget-angular/dist/styles/scenario-evolution-widget-angular.min.css'},
        ...
        debugCode: {
            ...
            src: ['.tmp/concat/scripts/scenario-evolution-widget-wirecloud.min.js'],
            dest: ['.tmp/concat/scripts/scenario-evolution-widget-wirecloud.min.js'],
            replacements: [
    ...
    compress: {
        main: {
         options: {
                mode: 'zip',
                archive: 'scenario-evolution-widget-wirecloud.min.wgt'
         },
         files: [
        ...
        nomin: {
         options: {
                mode: 'zip',
                archive: 'scenario-evolution-widget-wirecloud.wgt'
         },
         files: [
